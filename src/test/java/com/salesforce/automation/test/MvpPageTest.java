...
import static com.salesforce.automation.constants.SalesForceConstants.MVP_PAGE;
...
import com.salesforce.automation.helper.MvpDataHelper;
import com.salesforce.automation.pageModel.LoginPage;
import com.salesforce.automation.utility.XlsOperationsUtility;

@Listeners(ExtentReportListener.class)
public class MvpPageTest extends ExtentReportListener implements ITest
{
private static ThreadLocal<String> testName = new ThreadLocal<>();
	...
	@DataProvider(name = "MvpPage")
	public static Iterator<Object[]> getDataSet() throws Exception {
		List<MvpDataModel> dataSet = MvpDataHelper.retrievedataset();
		Collection<Object[]> data = new ArrayList<Object[]>();
		dataSet.forEach(item -> data.add(new Object[] { item }));
		return data.iterator();
	}

	@Test(dataProvider = "MvpPage")
	public void test_MvpPage(MvpDataModel handlerData) throws Exception {
		...
		try {
			for (String singleOperation : validationOperation) {
				Method m = keyWordClass.getDeclaredMethod(singleOperation, MvpDataModel.class);
	...
	public void BeforeMethod(Method method, Object[] testData, ITestContext ctx) {
		MvpDataModel handlerObj = (MvpDataModel) testData[0];
	...
	@BeforeClass
	public void before() {
		ExtentConfigurer.getInstance(MVP_PAGE);
		...
		try {
			...
			keyWordClass = Class.forName("com.salesforce.automation.pageModel.MvpPage");
